...
- 2026-06-16: Root `AGENTS.md` was added as a compressed token-saving version of the attached long guidance. Keep only durable behavior rules there; avoid long examples unless they prevent repeated mistakes.
