          ...
          {providerOptions.map(opt => (
            <button
              ...
              className={clsx(
                ...
                data.providerType === opt.v ? 'border-brand bg-emerald-50 text-brand' : 'border-slate-200 bg-white text-slate-600 hover:bg-slate-50',
              )}
            >
              {opt.label}
            </button>
            ...
            return (
              <label
                ...
                className={clsx(
                  ...
                  checked ? 'border-brand bg-emerald-50/60' : 'border-slate-200 bg-white hover:bg-slate-50',
                )}
              >
